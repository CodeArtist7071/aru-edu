...
const PerformanceAnalytics = lazy(
  () => import("./pages/userPanel/PerformanceAnalytics"),
);
...
const UserDashboardLayout = lazy(() =>
  import("./layouts/UserDashboardLayout").then((m) => ({
...
const ExamsManagement = lazy(
  () => import("./pages/adminPanel/ExamsManagement"),
);
const SubjectsManagement = lazy(
  () => import("./pages/adminPanel/SubjectsManagement"),
);
const ChaptersManagement = lazy(
  () => import("./pages/adminPanel/ChaptersManagement"),
);
const QuestionsManagement = lazy(
  () => import("./pages/adminPanel/QuestionsManagement"),
);
const FeaturesManagement = lazy(
  () => import("./pages/adminPanel/FeaturesManagement"),
);
const CurriculumLattice = lazy(
  () => import("./pages/adminPanel/CurriculumLattice"),
);
const ExamBoardsManagement = lazy(
  () => import("./pages/adminPanel/ExamBoardsManagement"),
);
const ExamGoalSelection = lazy(() => import("./pages/ExamSelection"));
const UserStudyPlanner = lazy(() =>
  import("./layouts/UserStudyPlanner").then((m) => ({
    default: m.UserStudyPlanner,
  })),
);
const ExamsPlanning = lazy(() =>
  import("./pages/userPanel/ExamsPlanning").then((m) => ({
    default: m.ExamsPlanning,
  })),
);
const ExamsList = lazy(() =>
  import("./pages/ExamsList").then((m) => ({ default: m.ExamsList })),
);
const ResultSelection = lazy(
  () => import("./pages/resultpage/ResultSelection"),
);
const AdminGuard = lazy(() =>
  import("./components/AdminGuard").then((m) => ({ default: m.AdminGuard })),
);
const MockTestPreferencePage = lazy(
  () => import("./pages/userPanel/MockTestPreferencePage"),
);
const AddRoutine = lazy(() =>
  import("./components/studyPlanner/AddRoutine").then((m) => ({
    default: m.AddRoutine,
  })),
);
const MasterySelector = lazy(
  () => import("./components/studyPlanner/MasterySelector"),
);
...
const router = createBrowserRouter(
  createRoutesFromElements(
    <>
      ...
      />
      <Route path="/guest/select-exams" element={<ExamGoalSelection />} />
      <Route
        path="/user"
        element={
          <ProtectedRoute>
      ...
      >
        <Route element={<GoalGuard />}>
          ...
          <Route path="mock-tests" element={<MockTests />}>
            <Route
              path="preference/:examId"
              element={<MockTestPreferencePage />}
            />
          </Route>
