        ...
        <div className="bg-surface-container-low p-4 rounded-3xl shadow-ambient group">
            ...
            <div className="flex flex-wrap gap-8 mt-10">
                <div className="flex items-center gap-4 group/item">
                    ...
                    <div>
                        <p className="text-[10px] font-technical font-black text-on-surface-variant uppercase tracking-widest opacity-40">Correct</p>
                ...
                <div className="flex items-center gap-4 group/item">
                    ...
                    <div>
                        <p className="text-[10px] font-technical font-black text-on-surface-variant uppercase tracking-widest opacity-40">Wrong</p>
                ...
                <div className="flex items-center gap-4 group/item">
                    ...
                    <div>
                        <p className="text-[10px] font-technical font-black text-on-surface-variant uppercase tracking-widest opacity-40">Skipped</p>
