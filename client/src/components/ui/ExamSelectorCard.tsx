  ...
  return (
    <section className="scroll-mt-15">
      <div className="flex justify-between items-center mb-8 px-2">
        ...
        <button
          onClick={onViewAll}
          className="text-xs cursor-pointer font-technical bg-primary/10 text-primary border border-primary/20 px-4 py-2 rounded-full font-black uppercase tracking-widest hover:bg-primary hover:text-white transition-all duration-300"
        >
          Add Exams +
        </button>
      </div>
